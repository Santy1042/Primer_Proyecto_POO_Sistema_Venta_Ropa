...
public class JDeleteSale extends javax.swing.JInternalFrame {
    ...
    private final ISaleService isalesService;

    /**
     * Constructor para NetBeans
     */
    public JDeleteSale() {
        this.isalesService = null;
        initComponents();
        setSize(600, 450);
     ...
     */
    public JDeleteSale(ISaleService isalesService) {
    ...
    private void initComponents() {
        ...
        tblProducts.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Cliente", "Detalles", "fecha", "Total"
            }
        ) {
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        try {
            ...
            if (isalesService != null) {
                Optional<Sale> optS = isalesService.findSale(id);
                if (optS.isPresent()) {
                    Sale s = optS.get();
                    txtName.setText(s.getClient().getName());
                    txtSize.setText(s.getClient().getLastName());
                    txtColor.setText(s.getClient().getEmail());
                    txtPrice.setText(String.valueOf(s.getTotal()));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // 1. Verificar que hayamos buscado una venta primero (UI check básico)
        ...
        try {
            ...
            // 4. Atrapar cualquier rechazo de la capa de negocio (ej. la venta fue borrada por otro usuario un segundo antes)
